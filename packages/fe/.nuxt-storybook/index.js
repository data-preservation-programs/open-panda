...
import nuxt_plugin_nuxtsocketio_291ae71c from 'nuxt_plugin_nuxtsocketio_291ae71c' // Source: ./nuxt-socket-io.js (mode: 'all')
import nuxt_plugin_axios_08b78706 from 'nuxt_plugin_axios_08b78706' // Source: ./axios.js (mode: 'all')
import nuxt_plugin_moment_1ce4eb52 from 'nuxt_plugin_moment_1ce4eb52' // Source: ./moment.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"OpenPanda","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"OpenPanda"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon\u002Ffavicon-96x96.png"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_nuxtsocketio_291ae71c === 'function') {
    await nuxt_plugin_nuxtsocketio_291ae71c(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_08b78706 === 'function') {
    await nuxt_plugin_axios_08b78706(app.context, inject)
  }

  if (typeof nuxt_plugin_moment_1ce4eb52 === 'function') {
    await nuxt_plugin_moment_1ce4eb52(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_seo_5e466527 === 'function') {
    await nuxt_plugin_seo_5e466527(app.context, inject)
  }

  if (typeof nuxt_plugin_scrollto_ee90aa76 === 'function') {
  ...
  if (typeof nuxt_plugin_pluginindex_09d53bb9 === 'function') {
    await nuxt_plugin_pluginindex_09d53bb9(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginhelpers_27071826 === 'function') {
    await nuxt_plugin_pluginhelpers_27071826(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginindex_90ab4632 === 'function') {
    await nuxt_plugin_pluginindex_90ab4632(app.context, inject)
  }
